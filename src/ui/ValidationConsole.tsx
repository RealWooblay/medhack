...
function EvidencePanel({ result, receipt, selectedDrug, productConfirmed, routine }: {
  ...
  return (
    <section className="screen" aria-labelledby="evidence-title">
      <div className="screen-heading">
        <h1 id="evidence-title">Report & sources</h1>
        <p>Key inputs, guidance and references for this result.</p>
      </div>

      <div className="evidence-groups">
        <details className="evidence-group">
          <summary><span>1</span><strong>Input</strong><small>File and processing details</small></summary>
        ...
        <details className="evidence-group">
          <summary><span>2</span><strong>Gene report</strong><small>Results and supporting sources</small></summary>
          <dl className="evidence-list">
        ...
        <details className="evidence-group">
          <summary><span>3</span><strong>Medicine guidance</strong><small>Guidance and references</small></summary>
          <div className="table-wrap">
            <table>
        ...
        <details className="evidence-group">
          <summary><span>4</span><strong>Daily-life guidance</strong><small>Selected medicine rules</small></summary>
        ...
        <details className="evidence-group">
          <summary><span>5</span><strong>Processing notes</strong><small>How this report is handled</small></summary>
          <dl className="evidence-list">
        ...
        <details className="evidence-group">
          <summary><span>6</span><strong>Export</strong><small>Download the complete run record</small></summary>
          <h3>Run input</h3>
          <pre>{JSON.stringify({
            fileName: receipt.fileName,
            source: receipt.source,
